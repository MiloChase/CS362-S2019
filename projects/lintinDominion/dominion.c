...
int adventurerCardEffect(int drawntreasure, struct gameState *state, int currentPlayer, int cardDrawn, int temphand[], int z) {
...
int mineCardEffect(int i, int j, struct gameState *state, int currentPlayer, int choice1, int choice2, int handPos) {
...
int remodelCardEffect(int i, int j, struct gameState *state, int currentPlayer, int choice1, int choice2, int handPos) {
      j = state->hand[currentPlayer][choice1];  //store card we will trash
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case adventurer:
      ...
      adventurerCardEffect(drawntreasure, state, currentPlayer, cardDrawn, temphand, z);
    ...
    case mine:
      ...
      mineCardEffect(i, j, state, currentPlayer, choice1, choice2, handPos);

    case remodel:

      remodelCardEffect(i, j, state, currentPlayer, choice1, choice2, handPos);
